...
public class Game extends Thread {
    ...
    private final static int[][] to = {{1, 0}, {-1, 0}, {0, 1}, {0, -1}};
    @Getter
    ...
    public Game(Integer rows, Integer cols, Integer inner_walls_count, Integer idA, Bot botA, Integer idB, Bot botB) {
        ...
        this.playerA = new Player(idA, rows - 2, 1, botIdA, botCodeA, new ArrayList<>());
        this.playerB = new Player(idB, 1, cols - 2, botIdB, botCodeB, new ArrayList<>());
    }
    ...
    private void sendMove() { // 想两个Client发送移动信息
        lock.lock();
        try {
